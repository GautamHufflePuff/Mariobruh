...
function startGame() {
  GameStatus = "start"
  document.getElementById("status").innerHTML="Its loadin' & ya know it!"
}
function game(){
 console.log("noseX = " + noseX + ", noseY = " + noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press da play button to stat the game...now! ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
